...
if __name__ == "__main__":
    ...
    for item_id in bar(range(len(item_list))):
        ...
        in_fn = f"{item['anno_id']}/point_sample/sample-points-all-pts-nor-rgba-10000.txt"
        ...
        in_label_fn = f"{item['anno_id']}/point_sample/sample-points-all-label-10000.txt"
        ...
        if k == n_shape or item_id+1 == len(item_list):
            ...
            save_h5(str(out_fn_prefix)+'.h5', batch_pts[:k, ...], batch_nor[:k, ...], batch_rgb[:k, ...], \
